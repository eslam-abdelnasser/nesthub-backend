        ...
        <div class="footer-top">
            <div class="row">
                <div class="col-lg-5 col-md-4 col-sm-3 col-xs-12">
                    <div class="logo-2">
                        <a href="index.html"> <img src="{{asset('front/img/footer-logo.png')}}" alt="footer-logo"> </a>
...
<div class="copy-right">
    <div class="container">
        &copy;  2017 <a href="http://nesthub.net/" target="_blank">NestHub</a>. Trademarks and brands are the property of their respective owners.
    </div>
</div>
<!-- Copy end right-->
<script type="text/javascript" src="{{asset('front/js/jquery-2.2.0.min.js')}}"></script>
<script type="text/javascript" src="{{asset('front/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('front/js/bootstrap-submenu.js')}}"></script>
<script type="text/javascript" src="{{asset('front/js/rangeslider.js')}}"></script>
<script type="text/javascript" src="{{asset('front/js/jquery.backstretch.min.js')}}"></script>
<script type="text/javascript" src="{{asset('front/js/jquery.mb.YTPlayer.js')}}"></script>
...
<script type="text/javascript" src="{{asset('front/js/leaflet.js')}}"></script>
...
<script type="text/javascript" src="{{asset('front/js/ie10-viewport-bug-workaround.js')}}"></script>
<!-- Custom javascript -->
<script type="text/javascript" src="{{asset('front/js/ie10-viewport-bug-workaround.js')}}"></script>
...
<script>
    $('.backstretch').backstretch([
        "{{asset('front/img/banner/banner-slider-2.jpg')}}"
        , "{{asset('front/img/banner/banner-slider-3.jpg')}}"
        , "{{asset('front/img/banner/banner-slider-1.jpg')}}"
    ], {
          fade: 800
        , duration: 5000
    });
